            ...
            <div class="hero-store-row" data-reveal="up">
                <a class="store-badge store-badge--hero" href="#download" aria-label="Google Play'den indir">
                    <span class="store-badge__icon" aria-hidden="true">
                        <img src="https://img.icons8.com/fluency/48/000000/google-play.png" alt="" loading="lazy" />
                    </span>
                ...
                <a class="store-badge store-badge--hero store-badge--appstore" href="#download" aria-label="App Store'dan indir">
                    <span class="store-badge__icon" aria-hidden="true">
                        <img src="https://img.icons8.com/fluency/48/ffffff/apple-app-store.png" alt="" loading="lazy" />
                    </span>
                    <span class="store-badge__content">
                        <span class="store-badge__eyebrow">Şimdi indir</span>
